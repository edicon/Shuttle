 ...
 */
package com.simplecity.amp_library.playback.mediaplayers.PrefUtils;
...
public class PreferenceUtils {
    ...
    private static final SharedPreferences mPreferences =
            PreferenceManager.getDefaultSharedPreferences(ShuttleApplication.getContext());
     ...
     */
    public static void attemptAskAccess(MainActivity activity) {
