...
public class FavoriteSongView extends MultiItemView {

    public Song song;

    private RequestManager requestManager;

    public FavoriteSongView(Song song, RequestManager requestManager) {
        this.song = song;
    ...
    public boolean equals(Object o) {
        ...
        FavoriteSongView that = (FavoriteSongView) o;
