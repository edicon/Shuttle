...
import com.simplecity.amp_library.ui.adapters.FavoriteSuggestAdapter;
...
public class FavoriteSuggestFragment extends BaseFragment implements
        MusicUtils.Defs,
        FavoriteSuggestAdapter.FavoriteListener,
    ...
    private static final String TAG = "FavoriteSuggestFragment";

    private static final String ARG_PAGE_TITLE = "page_title";

    private RecyclerView recyclerView;

    FavoriteSuggestAdapter favoriteAdapter;
    ...
    public FavoriteSuggestFragment() {
    }

    public static FavoriteSuggestFragment newInstance(String pageTitle) {
        FavoriteSuggestFragment fragment = new FavoriteSuggestFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        favoriteAdapter = new FavoriteSuggestAdapter();
    ...
    public void onOverflowClick(View v, int position, Object item) {
        if (item instanceof AlbumArtist) {
            PopupMenu menu = new PopupMenu(FavoriteSuggestFragment.this.getActivity(), v);
