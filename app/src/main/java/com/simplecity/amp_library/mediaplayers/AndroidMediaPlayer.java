...
public class AndroidMediaPlayer extends UniformMediaPlayer {
    ...
    private class CompletionListener implements MediaPlayer.OnCompletionListener {
        ...
        public void onCompletion(MediaPlayer mp) {
            ...
            // ToDo: ThreadManager.get().executePlayback(AndroidMediaPlayer.this, r);
        }
    }
    ...
    @Override
    public void prepare(final Query query, final UniformMediaPlayerCallback callback) {
